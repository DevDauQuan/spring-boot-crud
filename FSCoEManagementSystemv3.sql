...
/*  Created On : 09-May-2023 1:00:00 PM 				*/
/*  DBMS       : PostgreSQL 						*/
/* ---------------------------------------------------- */

/* Drop Tables */

DROP TABLE IF EXISTS "employee_utilization" CASCADE
;
...
DROP TABLE IF EXISTS "coe_core_team" CASCADE
;

DROP TABLE IF EXISTS "center_of_excellence" CASCADE
;
...
CREATE INDEX "IXFK_employee_practice" ON "employee" ("practice_id" ASC)
;
...
CREATE INDEX "IXFK_branch_location" ON "branch" ("location_id" ASC)
;
...
ALTER TABLE "employee" ADD CONSTRAINT "FK_employee_practice"
